...
<body>
 ...
 <script>
  function generateNigerianData(rows = 23) {
    const assignors = [
    ...
    const instrumentTypes = [
      ...
      "Lease Agreement", "Sales Agreement", "Transfer of Title",
    ];
    const sizes = ["0.0192ha"];
    const comments = [
      "R of O No: RES/2021/3006 Now owned by Abubakar Muhammad Dayyab with Plot/Plan No. GP No. 1067/1 & 1067/2",
      "", "Land dispute resolved", "Building plan approved", "Subject to survey",
      "Mortgage secured", "Lease renewed", "Sale completed", "Transfer registered",
