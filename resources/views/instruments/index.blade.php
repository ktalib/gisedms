...
@extends('layouts.app')
@section('page-title')
    {{ __('Instruments Registration Module') }}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item" aria-current="page"> {{ __('Instruments Registration Module') }}</li>
@endsection
@push('script-page')
                ...
                <table id="recordsTable" class="table table-striped dt-responsive nowrap" >
                    ...
                    <tbody>
                        @foreach($instruments as $instrument)
                            <tr>
                                <td>{{ $instrument->fileNoPrefix ?? 'N/A' }}0{{ $instrument->fileNumber ?? 'N/A' }}</td>
                                <td>{{ $instrument->GrantorName ?? 'N/A' }}</td>
                                <td>{{ $instrument->GranteeName ?? 'N/A' }}</td>
                        
                                <td>{{ $instrument->instrumentDate ?? 'N/A' }}</td>
                                <td>{{ $instrument->instrumentName ?? 'N/A' }}</td>
                                <td>{{ $instrument->instrumentDate ?? 'N/A' }}</td>
                                <td>{{ $instrument->propertyDescription ?? 'N/A' }}</td>
                                <td>{{ $instrument->regNo ?? 'N/A' }}</td>
                            <td>
                                <button type="button" class="btn btn-info open-actions-modal" data-bs-toggle="modal" data-bs-target="#actionsModal" data-id="{{ $instrument->id ?? '' }}">
                                     ...
                                     <div class="container">
                                       <div class="row">
                                          ...
                                          <div class="col-3 text-center mb-3">
                                            <button type="button" class="btn btn-primary w-100 view-record" data-id="{{ $instrument->id ?? '' }}">
...
<form action="{{ route('instruments.update', $instrument->id ?? 0) }}" method="POST" onsubmit="return false;" id="generateForm">
    @csrf
    <input type="hidden" id="particularsRegistrationNumber" name="particularsRegistrationNumber" class="" value="{{ $particularsRegistrationNumber}}">
...
function confirmGenerate() {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            ...
                                            <div class="record-value">{{ $instrument->fileNoPrefix ?? 'N/A' }}0{{ $instrument->fileNumber ?? 'N/A' }}</div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            ...
                                            <div class="record-value">{{ $instrument->regNo ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            ...
                                            <div class="record-value">{{ $instrument->particularsRegistrationNumber ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                              <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Root Title Reg Particulars</div>
                                            <div class="record-value">{{ $instrument->RootTitleRegNo ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Instrument Name</div>
                                            <div class="record-value">{{ $instrument->instrumentName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Instrument Date</div>
                                            <div class="record-value">{{ $instrument->instrumentDate ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            ...
                                            <div class="record-value">{{ $instrument->GrantorName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Grantor Address</div>
                                            <div class="record-value">{{ $instrument->GrantorAddress ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Grantee Name</div>
                                            <div class="record-value">{{ $instrument->GranteeName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Grantee Address</div>
                                            <div class="record-value">{{ $instrument->GranteeAddress ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            ...
                                            <div class="record-value">{{ $instrument->mortgagorName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Mortgagor Address</div>
                                            <div class="record-value">{{ $instrument->mortgagorAddress ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Mortgagee Name</div>
                                            <div class="record-value">{{ $instrument->mortgageeName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Mortgagee Address</div>
                                            <div class="record-value">{{ $instrument->mortgageeAddress ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Loan Amount</div>
                                            <div class="record-value">{{ $instrument->loanAmount ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Interest Rate</div>
                                            <div class="record-value">{{ $instrument->interestRate ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Duration</div>
                                            <div class="record-value">{{ $instrument->duration ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            ...
                                            <div class="record-value">{{ $instrument->assignorName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Assignor Address</div>
                                            <div class="record-value">{{ $instrument->assignorAddress ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Assignee Name</div>
                                            <div class="record-value">{{ $instrument->assigneeName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Assignee Address</div>
                                            <div class="record-value">{{ $instrument->assigneeAddress ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            ...
                                            <div class="record-value">{{ $instrument->lessorName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Lessor Address</div>
                                            <div class="record-value">{{ $instrument->lessorAddress ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Lessee Name</div>
                                            <div class="record-value">{{ $instrument->lesseeName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Lessee Address</div>
                                            <div class="record-value">{{ $instrument->lesseeAddress ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Lease Period</div>
                                            <div class="record-value">{{ $instrument->leasePeriod ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Lease Terms</div>
                                            <div class="record-value">{{ $instrument->leaseTerms ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            ...
                                            <div class="record-value">{{ $instrument->propertyDescription ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Property Address</div>
                                            <div class="record-value">{{ $instrument->propertyAddress ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Property Details</div>
                                            <div class="record-value">{{ $instrument->propertyDetails ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Original Plot Details</div>
                                            <div class="record-value">{{ $instrument->originalPlotDetails ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">New SubDivided Plot Details</div>
                                            <div class="record-value">{{ $instrument->newSubDividedPlotDetails ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Merged Plot Information</div>
                                            <div class="record-value">{{ $instrument->mergedPlotInformation ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Survey Plan No</div>
                                            <div class="record-value">{{ $instrument->surveyPlanNo ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">LGA</div>
                                            <div class="record-value">{{ $instrument->lga ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">District</div>
                                            <div class="record-value">{{ $instrument->district ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Size</div>
                                            <div class="record-value">{{ $instrument->size ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Plot Number</div>
                                            <div class="record-value">{{ $instrument->plotNumber ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            ...
                                            <div class="record-value">{{ $instrument->surrenderingPartyName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Receiving Party Name</div>
                                            <div class="record-value">{{ $instrument->receivingPartyName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Consideration Amount</div>
                                            <div class="record-value">{{ $instrument->considerationAmount ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Changes Variations</div>
                                            <div class="record-value">{{ $instrument->changesVariations ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Heir Beneficiary Details</div>
                                            <div class="record-value">{{ $instrument->heirBeneficiaryDetails ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Original Property Owner Details</div>
                                            <div class="record-value">{{ $instrument->originalPropertyOwnerDetails ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Assent Terms</div>
                                            <div class="record-value">{{ $instrument->assentTerms ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Releasor Name</div>
                                            <div class="record-value">{{ $instrument->releasorName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Releasee Name</div>
                                            <div class="record-value">{{ $instrument->releaseeName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Release Terms</div>
                                            <div class="record-value">{{ $instrument->releaseTerms ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Solicitor Name</div>
                                            <div class="record-value">{{ $instrument->solicitorName ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Solicitor Address</div>
                                            <div class="record-value">{{ $instrument->solicitorAddress ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Created At</div>
                                            <div class="record-value">{{ $instrument->created_at ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="record-field">
                                            <div class="record-label">Updated At</div>
                                            <div class="record-value">{{ $instrument->updated_at ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
  ...
  @include('instruments.instrument-modal')
</div>
