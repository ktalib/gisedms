            ...
            <div class="bg-gray-50 p-4 rounded-md">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6" id="myDiv" style="display: none;">
                    ...
                    <div>
                        ...
                        <input type="number" id="fileNumber" name="fileNumber" class="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" value="{{$tempFileNumber}}" disabled>
                        <div class="mt-2">
