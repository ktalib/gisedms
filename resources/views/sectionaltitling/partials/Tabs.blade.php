        ...
        <div class="border-b border-gray-200">
            <nav class="flex flex-wrap items-center justify-center md:space-x-4 lg:space-x-6">
                ...
                <a href="{{ route('sectionaltitling.index') }}" class="group flex flex-col items-center py-3 px-3 {{ request()->routeIs('sectionaltitling.index') ? 'border-b-2 border-blue-500' : 'hover:bg-gray-50 rounded-md' }}">
                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('sectionaltitling.index') ? 'bg-blue-100 text-blue-600' : 'text-gray-500 group-hover:text-blue-600' }} rounded-full mb-1">
                ...
                <a href="{{ route('customer-care.index') }}" class="group flex flex-col items-center py-3 px-3 {{ request()->routeIs('customer-care.index') ? 'border-b-2 border-green-500' : 'hover:bg-gray-50 rounded-md' }}">
                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('customer-care.index') ? 'bg-green-100 text-green-600' : 'text-gray-500 group-hover:text-green-600' }} rounded-full mb-1">
                ...
                <a href="{{ route('sectionaltitling.primary') }}" class="group flex flex-col items-center py-3 px-3 {{ request()->routeIs('sectionaltitling.primary') ? 'border-b-2 border-purple-500' : 'hover:bg-gray-50 rounded-md' }}">
                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('sectionaltitling.primary') ? 'bg-purple-100 text-purple-600' : 'text-gray-500 group-hover:text-purple-600' }} rounded-full mb-1">
                ...
                <a href="#" class="group flex flex-col items-center py-3 px-3 hover:bg-gray-50 rounded-md">
                    <div class="flex items-center justify-center w-8 h-8 text-gray-500 group-hover:text-red-600 rounded-full mb-1">
                ...
                {{-- Survey --}}
                <a href="#" class="group flex flex-col items-center py-3 px-3 hover:bg-gray-50 rounded-md">
                    <div class="flex items-center justify-center w-8 h-8 text-gray-500 group-hover:text-amber-600 rounded-full mb-1">
                ...
                <a href="{{ route('programmes.entity') }}" class="group flex flex-col items-center py-3 px-3 {{ request()->routeIs('programmes.entity') ? 'border-b-2 border-indigo-500' : 'hover:bg-gray-50 rounded-md' }}">
                    <div class="flex items-center justify-center w-8 h-8 {{ request()->routeIs('programmes.entity') ? 'bg-indigo-100 text-indigo-600' : 'text-gray-500 group-hover:text-indigo-600' }} rounded-full mb-1">
                ...
                {{-- Operations --}}
                <a href="#" class="group flex flex-col items-center py-3 px-3 hover:bg-gray-50 rounded-md">
                    <div class="flex items-center justify-center w-8 h-8 text-gray-500 group-hover:text-teal-600 rounded-full mb-1">
