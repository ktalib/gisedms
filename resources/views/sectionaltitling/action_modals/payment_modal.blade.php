...
<div id="paymentModal" class="fixed inset-0 z-50 hidden overflow-y-auto ">
                    ...
                    <div class="p-4">
                      ...
                      <!-- Property Details -->
                        ...
                        <div class="grid grid-cols-2 gap-2 text-xs">
                          <div>
                          <p><span class="font-medium">Form No:</span> FormID</p>
                          <p><span class="font-medium" id="display_file_no">File No:</span> </p>
                          <p><span class="font-medium">Name of Section Owner:</span></p>
                          <p><span class="font-medium">Plot Size:</span></p>
                          </div>
                          <div>
                          <p><span class="font-medium">Land Use:</span></p>
                          <p><span class="font-medium">Location:</span></p>
                          <p><span class="font-medium">Approval Date:</span></p>
                          </div>
                        </div>
                        </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const displayFileNos = document.querySelectorAll('#display_file_no');
        ...
        paymentBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                fetch(`/gisedms/mother-applications/${id}`)
                    .then(response => {
                        if (!response.ok) {
                    ...
                    .then(data => {
                        ...
                        if (displayFileNos) {
                            displayFileNos.forEach(fileNoElement => {
                                fileNoElement.textContent = data.fileno ?? '';
                            });
                        }
