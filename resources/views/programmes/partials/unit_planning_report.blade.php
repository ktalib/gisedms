<div class="bg-white rounded-md shadow-sm border border-gray-200 p-6 mb-6">
    <h3 class="text-lg font-semibold mb-4">Planing Recommendations Status Breakdown</h3>
    <div class="grid grid-cols-3 gap-4 mb-6">
   
      <div class="stat-card border-l-4 border-green-500 pl-3">
        <div class="flex justify-between items-start mb-4">
          <h3 class="text-gray-600 font-medium">Approved Unit</h3>
      ...
      <div class="stat-card border-l-4 border-red-500 pl-3">
        ...
        <div class="text-3xl font-bold text-red-600">{{ $rejectedUnitApplications}}</div>
        <div class="flex items-center mt-2 text-sm">
      ...
      <div class="stat-card border-l-4 border-amber-500 pl-3">
        ...
        <div class="text-3xl font-bold text-amber-600">{{ $pendingUnitApplications }}</div>
        <div class="flex items-center mt-2 text-sm">
