...
@extends('layouts.app')
@section('page-title')
    {{ __('GIS Data Capture Module') }}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item" aria-current="page"> {{ __('GIS Data Capture Module') }}</li>
@endsection
@push('script-page')
        ...
        <div class="container">
            ...
            <div>
                <div class="card shadow-sm" style="width:100%">
                    <div class="card-body">
                        <form action="{{ route('propertycard.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
