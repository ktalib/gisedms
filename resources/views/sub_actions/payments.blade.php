                                  ...
                                  <div class="p-4 space-y-4">
                                    <div class="grid grid-cols-2 gap-4">
                                      <div class="space-y-2">
                                        ...
                                        <input id="application-fee" type="text" value="{{ $application->application_fee ?? '0.00' }}" class="w-full p-2 border border-gray-300 rounded-md text-sm" disabled>
                                      </div>
                                      <div class="space-y-2">
                                        <label for="processing-fee" class="text-xs font-medium block">
                                          Processing Fee (₦)
                                        </label>
                                        <input id="processing-fee" type="text" value="{{ $application->processing_fee ?? '0.00' }}" class="w-full p-2 border border-gray-300 rounded-md text-sm" disabled>
                                      </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                      <div class="space-y-2">
                                        ...
                                        <input id="site-plan-fee" type="text" value="{{ $application->site_plan_fee ?? '0.00' }}" class="w-full p-2 border border-gray-300 rounded-md text-sm" disabled>
                                      </div>
                                      <div class="space-y-2">
                                        <label for="payment-date" class="text-xs font-medium block">
                                          Payment Date
                                        </label>
                                        <input id="payment-date" type="text" value="{{ $application->payment_date ?? 'Not paid yet' }}" class="w-full p-2 border border-gray-300 rounded-md text-sm" disabled>
                                      </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                      <div class="space-y-2">
                                        ...
                                        <input id="receipt-number" type="text" value="{{ $application->receipt_number ?? 'N/A' }}" class="w-full p-2 border border-gray-300 rounded-md text-sm" disabled>
                                      </div>
                                    </div>
                                 ...
                                 <div class="p-4 space-y-4">
                                   <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="space-y-2">
                                      ...
                                      <input id="land-size" type="text" value="1,200" class="w-full p-2 border border-gray-300 rounded-md text-sm" disabled>
                                    </div>
                                   </div>
                                   ...
                                   <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="space-y-2">
                                      ...
                                      <input id="units-count" type="text" value="12" class="w-full p-2 border border-gray-300 rounded-md text-sm" disabled>
                                    </div>
                                   </div>
