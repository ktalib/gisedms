                ...
                <div class="modal-content p-6">
                    ...
                    <div class="py-2">
                      ...
                      <div class="grid grid-cols-3 gap-2 mb-4">
                        ...
                        <form id="survey-form" method="POST" data-mode="create">
                        @csrf
                        <!-- Survey Tab -->
                        <div id="initial-tab" class="tab-content active">
                          ...
                          <input type="hidden" id="application_id" name="sub_application_id" value="{{$application->id}}">
                          ...
                          <div class="flex gap-2">
                            <a href="{{route('sectionaltitling.secondary')}}" class="flex items-center px-3 py-1 text-xs border border-gray-300 rounded-md bg-white hover:bg-gray-50">
                            ...
                            <button type="button" id="edit-survey" class="flex items-center px-3 py-1 text-xs border border-gray-300 rounded-md bg-white hover:bg-gray-50">
