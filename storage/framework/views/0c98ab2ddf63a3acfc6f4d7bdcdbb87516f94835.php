                        ...
                        <td class="relative">
                           ...
                           <button onclick="toggleDropdown(this)" class="p-2 rounded-full bg-gray-200 hover:bg-gray-300 focus:outline-none border-2 border-gray-400">
                            ...
                            <ul class="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg hidden action-menu z-50">
                             ...
                             <li>
                               <button type="button" class="block w-full text-left px-4 py-2 hover:bg-gray-100 flex items-center text-sm approve-btn" data-id="<?php echo e($subApplication->id); ?>" data-fileno="<?php echo e($subApplication->fileno); ?>">
                                 <i class="material-icons text-success me-2">check_circle</i> Director's Approval
                               </button>
                              </li>

                              <li>
                               <button type="button" class="block w-full text-left px-4 py-2 hover:bg-gray-100 flex items-center text-sm" data-bs-toggle="modal" data-bs-target="#actionsModal<?php echo e($subApplication->id); ?>" <?php if($subApplication->application_status != 'Approved'): ?> disabled <?php endif; ?>>
                                 <i class="material-icons text-danger me-2">apps</i> Actions
                               </button>
                              </li>

                              <li>
                               <button type="button" class="block w-full text-left px-4 py-2 hover:bg-gray-100 flex items-center text-sm generate-bill" data-id="<?php echo e($subApplication->id); ?>" data-main_fileno="<?php echo e($subApplication->main_fileno); ?>" data-fileno="<?php echo e($subApplication->fileno); ?>" data-applicant-title="<?php echo e($subApplication->applicant_title); ?>" data-owner-name="<?php if($subApplication->multiple_owners_names): ?><?php echo e($subApplication->multiple_owners_names); ?><?php elseif($subApplication->corporate_name): ?><?php echo e($subApplication->corporate_name); ?><?php else: ?><?php echo e($subApplication->applicant_title); ?> <?php echo e($subApplication->first_name); ?> <?php echo e($subApplication->surname); ?> <?php echo e($subApplication->middle_name); ?><?php endif; ?>" data-plot-house-no="<?php echo e($subApplication->plot_house_no); ?>" data-plot-street-name="<?php echo e($subApplication->plot_street_name); ?>" data-owner-district="<?php echo e($subApplication->owner_district); ?>" data-address="<?php echo e($subApplication->address); ?>" data-plot_size="<?php echo e($subApplication->plot_size); ?>" data-land_use="<?php echo e($subApplication->land_use); ?>" data-approval-date="<?php echo e($subApplication->approval_date); ?>" <?php if($subApplication->application_status != 'Approved'): ?> disabled <?php endif; ?>>
                                 <i class="material-icons me-2">receipt</i> Generate Bill
                               </button>
                              </li>
                             
                              <li>
                               <button type="button" class="block w-full text-left px-4 py-2 hover:bg-gray-100 flex items-center text-sm" data-bs-toggle="modal" data-bs-target="#certificateModal<?php echo e($subApplication->id); ?>" <?php if($subApplication->application_status != 'Approved'): ?> disabled <?php endif; ?>>
