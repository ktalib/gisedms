                            ...
                            <li class="list-group-item">
                                ...
                                <div class="theme-color preset-color">
                                    <a href="#!" data-value="preset-1"
                                        class="<?php echo e($settings['accent_color'] == 'preset-1' ? 'active' : ''); ?>"><i
                                            class="ti ti-check"></i></a>
                                    <a href="#!" data-value="preset-2"
                                        class="<?php echo e($settings['accent_color'] == 'preset-2' ? 'active' : ''); ?>"><i
                                            class="ti ti-check"></i></a>
                                    <a href="#!" data-value="preset-3"
                                        class="<?php echo e($settings['accent_color'] == 'preset-3' ? 'active' : ''); ?>"><i
                                            class="ti ti-check"></i></a>
                                    <a href="#!" data-value="preset-4"
                                        class="<?php echo e($settings['accent_color'] == 'preset-4' ? 'active' : ''); ?>"><i
                                            class="ti ti-check"></i></a>
                                    <a href="#!" data-value="preset-5"
                                        class="<?php echo e($settings['accent_color'] == 'preset-5' ? 'active' : ''); ?>"><i
                                            class="ti ti-check"></i></a>
                                    <a href="#!" data-value="preset-6"
                                        class="<?php echo e($settings['accent_color'] == 'preset-6' ? 'active' : ''); ?>"><i
                                            class="ti ti-check"></i></a>
                                    <a href="#!" data-value="preset-7"
                                        class="<?php echo e($settings['accent_color'] == 'preset-7' ? 'active' : ''); ?>"><i
                                            class="ti ti-check"></i></a>
                                </div>
                            </li>
                            <li class="list-group-item">
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\gisedms\resources\views/admin/footer.blade.php ENDPATH**/ ?>