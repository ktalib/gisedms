...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item" aria-current="page"> <?php echo e(__('Property Records Assistant')); ?> </li>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="modal-container bg-white w-11/12 md:max-w-4xl mx-auto rounded-md shadow-lg z-50 overflow-y-auto">
                ...
                <div class="bg-gray-100 p-3 border-b flex justify-between items-center"> 
                    <div class="flex items-center space-x-2">
                        ...
                        <p id="recordCounter" class="text-lg font-semibold text-gray-700"><?php echo e(isset($result) ? $result->id : ''); ?> of <?php echo e($recordCount); ?></p>
                    ...
                    <div class="flex space-x-2">
                        ...
                        <button class="p-1 bg-green-600 text-white hover:bg-green-700" title="Add" onclick="window.location.href='<?php echo e(route('propertycard.create')); ?>'" >
                ...
                <!-- Modal Content -->
                <div class="p-2">
                    <form method="POST" action="<?php echo e(route('propertycard.saveRecord')); ?>" id="propertyCardForm">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" id="currentRecordId" name="currentRecordId" value="<?php echo e(isset($result) ? $result->id : ''); ?>">
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="grid grid-cols-3 gap-2 mb-6">
                                    <div>
                                        ...
                                        <select id="fileNoPrefix" name="fileNoPrefix" class="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" style="color: black;">
                                            ...
                                            <?php $__currentLoopData = ['KNML', 'MNKL', 'KN', 'CON-COM', 'CON-RES', 'RES', 'MLKN', 'CON-AG', 'KNGP', 'CON-IND']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prefix): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($prefix); ?>" <?php echo e((isset($result) && isset($result->fileNoPrefix) && $result->fileNoPrefix == $prefix) ? 'selected' : ''); ?>>
                                                    <?php echo e($prefix); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="fileNumber" name="fileNumber" class="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" value="<?php echo e(isset($result) ? ($result->fileNumber ?: 'N/A') : 'N/A'); ?>" style="color: black;">
                                    </div>
                                    <div>
                                        <label for="Previewflenumber" class="block text-sm font-medium text-gray-700 mb-1">Full File Number</label>
                                        <input type="text" id="Previewflenumber" name="Previewflenumber" class="w-full p-2 border border-gray-300 bg-gray-100 font-medium rounded-md" value="<?php echo e(isset($result) ? ($result->kangisFileNo ?: 'N/A') : 'N/A'); ?>" readonly style="color: black;">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-6 gap-2 mb-2">
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" id="oldTitleSerialNo" name="oldTitleSerialNo" class="w-full border rounded p-1 text-xs" value="<?php echo e(isset($result) ? ($result->oldTitleSerialNo ?: 'N/A') : 'N/A'); ?>" />
                                    </div>
                                    <div class="col-span-2">
                                        <label for="oldTitlePageNo" class="block text-xs text-gray-600 mb-1">Page</label>
                                        <input type="text" id="oldTitlePageNo" name="oldTitlePageNo" class="w-full border rounded p-1 text-xs" value="<?php echo e(isset($result) ? ($result->oldTitlePageNo ?: 'N/A') : 'N/A'); ?>" />
                                    </div>
                                    <div class="col-span-2">
                                        <label for="oldTitleVolumeNo" class="block text-xs text-gray-600 mb-1">Vol</label>
                                        <input type="text" id="oldTitleVolumeNo" name="oldTitleVolumeNo" class="w-full border rounded p-1 text-xs" value="<?php echo e(isset($result) ? ($result->oldTitleVolumeNo ?: 'N/A') : 'N/A'); ?>" />
                                    </div>
                                </div>

                                <div class="mb-2">
                                    <label for="description" class="block text-xs text-gray-600 mb-1">Description</label>
                                    <input type="text" id="description" name="description" class="w-full border rounded p-1 text-xs" value="<?php echo e(isset($result) ? ($result->description ?: 'N/A') : 'N/A'); ?>"  />
                                </div>

                                <div class="grid grid-cols-6 gap-2 mb-2">
                                    <div class="col-span-3">
                                        <label for="lgaName" class="block text-xs text-gray-600 mb-1">Lgsa Or City</label>
                                        <input type="text" id="lgaName" name="lgaName" class="w-full border rounded p-1 text-xs" value="<?php echo e(isset($result) ? ($result->lgaName ?: 'N/A') : 'N/A'); ?>" />
                                    </div>
                                    <div class="col-span-3">
                                        <label for="plotNo" class="block text-xs text-gray-600 mb-1">Plot No</label>
                                        <input type="text" id="plotNo" name="plotNo" class="w-full border rounded p-1 text-xs" value="<?php echo e(isset($result) ? ($result->plotNo ?: 'N/A') : 'N/A'); ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-2 mb-2">
                                    <div>
                                        ...
                                        <input type="text" id="originalAllottee" name="originalAllottee" class="w-full border rounded p-1 text-xs" value="<?php echo e(isset($result) ? ($result->originalAllottee ?: 'N/A') : 'N/A'); ?>" />
                                    </div>
                                    <div>
                                        <label for="currentAllottee" class="block text-xs text-gray-600 mb-1">Assignee</label>
                                        <input type="text" id="currentAllottee" name="currentAllottee" class="w-full border rounded p-1 text-xs" value="<?php echo e(isset($result) ? ($result->currentAllottee ?: 'N/A') : 'N/A'); ?>" />
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <select id="layoutName" name="layout" class="w-full border rounded p-1 pr-6 appearance-none text-xs">
                                                <option value=""><?php echo e(isset($result) ? ($result->layoutName ?: 'N/A') : 'N/A'); ?></option>
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="border rounded">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="relative mt-1">
                                            <input type="text" id="lgaName" name="lgaName" class="w-full border rounded p-1 text-xs lgsa-input" value="<?php echo e(request('lgaName')); ?>" disabled />
                                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-1 text-gray-700">
                                                <svg class="h-3 w-3" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path d="M19 9l-7 7-7-7"></path>
                                                </svg>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="Assignor" name="originalAllottee" class="w-full border rounded p-1 mt-1 text-xs grantor-input" value="<?php echo e(request('originalAllottee')); ?>" disabled />
                                    </div>

                                    <div class="mb-1">
                                        <input type="checkbox" id="Assignee" class="mr-1 grantee-checkbox" />
                                        <label for="Assignee" class="text-xs">Assignee</label>
                                        <input type="text" id="Assignee" name="currentAllottee" class="w-full border rounded p-1 mt-1 text-xs grantee-input" value="<?php echo e(request('currentAllottee')); ?>" disabled />
                                    </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="relative mt-1">
                                            <input type="text" id="mlsfNo" name="mlsfNo" class="w-full border rounded p-1 text-xs" value="<?php echo e(request('mlsfNo')); ?>" disabled />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="kangisFileNo" name="kangisFileNo" class="w-full border rounded p-1 text-xs" value="<?php echo e(request('kangisFileNo')); ?>" disabled />
                                    </div>
                                    <div class="flex justify-between">
                                        <button type="submit" id="findButton" formaction="<?php echo e(route('propertycard.search')); ?>" class="p-0.5 border rounded flex items-center space-x-1 w-20 bg-green-600 text-white justify-center">
                                    ...
                                    document.getElementById('refreshButton').addEventListener('click', function() {
                                        ...
                                        document.getElementById('recordCounter').innerText = "0 of <?php echo e($recordCount); ?>";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('findButton').addEventListener('click', function() {
            ...
            fetch('<?php echo e(route('propertycard.search')); ?>', {
                method: 'POST',
                headers: {
...
document.getElementById('saveButton').addEventListener('click', function() {
    ...
    fetch('<?php echo e(route('propertycard.saveRecord')); ?>', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
        },
...
document.getElementById('previousButton').addEventListener('click', function() {
    ...
    fetch("<?php echo e(route('propertycard.navigate')); ?>", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
document.getElementById('findButton').addEventListener('click', function(e) {
    ...
    // Add CSRF token
    searchData._token = '<?php echo e(csrf_token()); ?>';
...
function updateFormFields(data) {
    ...
    if (recordCounter && record.id) {
        recordCounter.innerText = record.id + " of " + '<?php echo e($recordCount); ?>';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (recordCounter && !document.getElementById('currentRecordId').value) {
        recordCounter.innerText = "0 of <?php echo e($recordCount); ?>";
    }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\gisedms\resources\views/propertycard/create.blade.php ENDPATH**/ ?>