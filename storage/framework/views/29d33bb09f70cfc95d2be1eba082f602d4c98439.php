                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($application->multiple_owners_names): ?>
                                            ...
                                            <?php else: ?>
                                                <?php echo e($application->first_name); ?> <?php echo e($application->middle_name); ?> <?php echo e($application->surname); ?>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <button type="button" class="btn btn-icon btn-info open-actions-modal" data-id="<?php echo e($application->id); ?>" data-bs-toggle="modal" data-bs-target="#actionsModal" data-bs-toggle="tooltip" title="Actions">
                                                <i class="fa fa-th"></i>
                                            </button>
