                                        ...
                                        <a class="nav-link <?php echo e(empty($activeTab) || $activeTab == 'user_profile_settings' ? ' active ' : ''); ?>"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    ...
                                                    <small class="text-muted"><?php echo e(__('User Account Profile Settings')); ?></small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\gisedms\resources\views/settings/index.blade.php ENDPATH**/ ?>