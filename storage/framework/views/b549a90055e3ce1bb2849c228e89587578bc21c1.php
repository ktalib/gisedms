...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>" class="text-blue-600 hover:text-blue-800"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item text-gray-500" aria-current="page"><?php echo e(__('Application Form')); ?></li>
<?php $__env->stopSection(); ?>
