    ...
    <div class="card shadow-sm">
        <div class="card-body" style="width:100%">
            ...
            <form method="POST" class="space-y-6" action="<?php echo e(route('sectionaltitling.storeMotherApp')); ?>" enctype="multipart/form-data">
                ...
                <input type="hidden" name="applicant_type" id="applicantType" value="" required>
                ...
                <div class="form-section">
                    ...
                    <div>
                        ...
                        <input type="text" id="ownerPlotNo" name="owner_plot_no" class="w-full p-2 border border-gray-300 rounded-md" placeholder="No Of Units" oninput="updateOwnerFullAddress()">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\gisedms\resources\views/sectionaltitling/create.blade.php ENDPATH**/ ?>