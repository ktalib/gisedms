<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Legal Search')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item" aria-current="page"> <?php echo e(__('Legal Search')); ?></li>
<?php $__env->stopSection(); ?>
                        ...
                        <div class="search-container">
                            <div class="custom-select">
                                ...
                                <div class="options-container" id="options-container">
                                    <div class="option" data-value="KN0001"><a href="<?php echo e(route('notification.index')); ?>">KN0001</a></div>
                                    <div class="option" data-value="KNML 09475"><a href="<?php echo e(route('notification.index')); ?>">KNML 09475</a></div>
                                    <div class="option" data-value="CON-RES-2018-242"><a href="<?php echo e(route('notification.index')); ?>">CON-RES-2018-242</a></div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function populateTable() {
            ...
            jsonData.forEach(row => {
                ...
                tr.innerHTML = `
                    <td class="border px-4 py-2"><a href="<?php echo e(route('notification.index')); ?>">${row.grantor}</a></td>
                    <td class="border px-4 py-2"><a href="<?php echo e(route('notification.index')); ?>">${row.grantee}</a></td>
                    <td class="border px-4 py-2"><a href="<?php echo e(route('notification.index')); ?>">${row.location}</a></td>
                    <td class="border px-4 py-2"><a href="<?php echo e(route('notification.index')); ?>">${row.mlsFileNo}</a></td>
                    <td class="border px-4 py-2"><a href="<?php echo e(route('notification.index')); ?>">${row.kangisFileNo}</a></td>
                    <td class="border px-4 py-2"><a href="<?php echo e(route('notification.index')); ?>">${row.newKangisFileNo}</a></td>
                    <td class="border px-4 py-2"><a href="<?php echo e(route('notification.index')); ?>">${row.registrationParticulars}</a></td>
                    <td class="border px-4 py-2"><a href="<?php echo e(route('notification.index')); ?>">${row.plotNo}</a></td>
                    <td class="border px-4 py-2"><a href="<?php echo e(route('notification.index')); ?>">${row.plotDescription}</a></td>
                    <td class="border px-4 py-2"><a href="<?php echo e(route('notification.index')); ?>">${row.lga}</a></td>
                `;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\gisedms\resources\views/note/index.blade.php ENDPATH**/ ?>